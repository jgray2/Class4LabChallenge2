...
public class CalcRectForwardController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        rect.setLegA(Double.parseDouble(request.getParameter("rlegA")));
        rect.setLegB(Double.parseDouble(request.getParameter("rlegB")));
        rect.calculateArea();
        request.setAttribute("rArea", String.valueOf(rect.getArea()));

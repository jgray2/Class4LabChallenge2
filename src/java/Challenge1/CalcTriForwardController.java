...
public class CalcTriForwardController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        tri.setLegA(Double.parseDouble(request.getParameter("tLegA")));
        tri.setLegB(Double.parseDouble(request.getParameter("tLegB")));
        tri.calculateLegC();
 
        request.setAttribute("tLegC", String.valueOf(tri.getLegC()));
